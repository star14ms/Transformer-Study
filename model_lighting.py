...
from model import AdditionTransformerEncoder, AdditionTransformer, AdditionTransformerV2, DateTransformer
...
class AdditionTransformerL(pl.LightningModule):
    def __init__(self, vocab_size=len(vocab), d_model=32, nhead=8, num_encoder_layers=1, num_decoder_layers=1, dim_feedforward=32, batch_first=True, *args, **kwargs):
        super().__init__()
        self.model = AdditionTransformerV2(vocab_size=vocab_size, d_model=d_model, nhead=nhead, num_encoder_layers=num_encoder_layers, num_decoder_layers=num_decoder_layers, dim_feedforward=dim_feedforward, batch_first=batch_first)
